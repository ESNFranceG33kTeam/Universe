...
* [Universe/menu/buttonManager](#module_Universe/menu/buttonManager)
    * [.create_new_button(site)](#module_Universe/menu/buttonManager.create_new_button)
    * [.update_tooltip_title(site, title)](#module_Universe/menu/buttonManager.update_tooltip_title)
    * [.update_button_image(site, image_url)](#module_Universe/menu/buttonManager.update_button_image)
    * [.add_loader(site)](#module_Universe/menu/buttonManager.add_loader)
    * [.remove_loader(site)](#module_Universe/menu/buttonManager.remove_loader)

<a name="module_Universe/menu/buttonManager.create_new_button"></a>

### Universe/menu/buttonManager.create_new_button(site)
...
<a name="module_Universe/menu/buttonManager.update_tooltip_title"></a>
...
<a name="module_Universe/menu/buttonManager.update_button_image"></a>

### Universe/menu/buttonManager.update_button_image(site, image_url)
...
<a name="module_Universe/menu/buttonManager.add_loader"></a>
...
<a name="module_Universe/menu/buttonManager.remove_loader"></a>
...
* [Universe/frameManager](#module_Universe/frameManager)
    * [.hide_loading_screen()](#module_Universe/frameManager.hide_loading_screen)
    * [.show_frame(url)](#module_Universe/frameManager.show_frame)
    * [.show_home()](#module_Universe/frameManager.show_home)
    * [.create_new_frame(site)](#module_Universe/frameManager.create_new_frame)
    * [.delete_frame(site)](#module_Universe/frameManager.delete_frame)
    * [.reset_frame(site)](#module_Universe/frameManager.reset_frame)
    * [.trigger_tutorial_mode()](#module_Universe/frameManager.trigger_tutorial_mode)

<a name="module_Universe/frameManager.hide_loading_screen"></a>
...
**Access**: public  
**Author**: Rémy Raes  
<a name="module_Universe/frameManager.show_frame"></a>

### Universe/frameManager.show_frame(url)
...
<a name="module_Universe/frameManager.show_home"></a>
...
**Access**: public  
**Author**: Rémy Raes  
<a name="module_Universe/frameManager.create_new_frame"></a>

### Universe/frameManager.create_new_frame(site)
...
<a name="module_Universe/frameManager.delete_frame"></a>
...
<a name="module_Universe/frameManager.reset_frame"></a>
...
<a name="module_Universe/frameManager.trigger_tutorial_mode"></a>
